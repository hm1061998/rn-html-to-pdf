                ...
                withRejecter:(RCTPromiseRejectBlock)reject)
{
    ...
    CGRect mediaBox = [pdfPage boundsForBox:kPDFDisplayBoxMediaBox];
    CGContextRef context = UIGraphicsGetCurrentContext();
    [attributedString drawWithRect:mediaBox options:NSStringDrawingUsesLineFragmentOrigin context:nil];
